...
<br/>Astro es un framework potente que admite tanto la generación de sitios estáticos (SSG) como el renderizado del lado del servidor (SSR).</p>
      <div className="d-grid gap-2 d-md-flex justify-content-md-start">
        <a type="button" className="btn btn-dark btn-md" href='https://astro.build/' target='_blank'>Ir a la web oficial de astro</a>
      </div>
    </div>
  </div>
</div>
...
<div className="container col-xxl-8 px-4 py-5">
  <div className="row flex-lg-row- align-items-center g-5 py-5">
    ...
    <div className="col-lg-6">
      ...
      <div className="d-grid gap-2 d-md-flex justify-content-md-start">
        <a type="button" className="btn btn-dark btn-md" href='https://dummyjson.com/' target='_blank'>Ir a la web oficial de DummyJSON</a>
      </div>
    </div>
  </div>
</div>
...
<br/>Astro es un framework potente que admite tanto la generación de sitios estáticos (SSG) como el renderizado del lado del servidor (SSR).</p>
      <div className="d-grid gap-2 d-md-flex justify-content-md-start">
        <a type="button" className="btn btn-dark btn-md" href='https://getbootstrap.com/docs/5.3/getting-started/introduction/' target='_blank'>Ir a la web oficial de Bootstrap</a>
      </div>
    </div>
  </div>
</div>
